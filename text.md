...
คลาสที่มีตัวแปรโดยทั่วไปจะเป็นตัวแปรของคลาส จะถูกเรียกว่า static variable เมื่อ static variable ถูกประกาศเป็น static พื้นที่สำหรับมันถูกแบ่งไว้สำหรับ lifetime ของโปรแกรม การตั้งชื่อตัวแปรของคลาสจะขึ้นต้นด้วย @@  ข้อมูลที่เก็บใน cstatic variable จะถูกเเชร์ให้กับทุก object ของ class
>
>
```Ruby
class A
...
คูเปอร์, พี. (2016). การเริ่มต้นเขียนโปรแกรมรูบี้: จากผู้เริ่มต้นสู่ระดับมืออาชีพ (พิมพ์ครั้งที่ 3, น. 113–115). เอเพรส.
