# Static Members
 ...
 เเละคลาส คุณสมบัติหลักๆของ Static สามารถเข้าถึงได้โดยไม่ต้องสร้าง object คือสามารถเรียกใช้งานเมธอดผ่านคลาส เเละตัวแปรที่เป็น static จะถูกผูกเข้ากับคลาสจะถูกแชร์ให้กับobject คลาสเดียวกัน ตัวอย่างเช่น 
 >
